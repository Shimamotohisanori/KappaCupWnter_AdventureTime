...
namespace nsK2Engine {
    ...
    {
        // 太陽光
        m_light.directionalLight[0].color.x = 1.2f;//もとは1.2f
        m_light.directionalLight[0].color.y = 1.2f;//もとは1.2f
        m_light.directionalLight[0].color.z = 1.2f;//もとは1.2f
      ...
      /*  m_light.directionalLight[1].color.x = 1.0f;
        ...
        m_light.ambinetLight.x = 0.1f;//もとは0.1
        m_light.ambinetLight.y = 0.1f;//もとは0.1
        m_light.ambinetLight.z = 0.1f;//もとは0.1
